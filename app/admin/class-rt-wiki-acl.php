...
if ( ! class_exists( 'Rt_Wiki_ACL' ) ) {
	class Rt_Wiki_ACL {
		...
		public function __construct() {
			add_filter( 'rtbiz_modules', array( $this, 'register_rt_wiki_module' ) );
		}

		function register_rt_wiki_module( $modules ) {
			global $rt_wiki_roles;
			$module_key = ( function_exists( 'rtbiz_sanitize_module_key' ) ) ? rtbiz_sanitize_module_key( RT_WIKI_TEXT_DOMAIN ) : '';
