    ...
    class Rt_Wiki_Subscribe {
        ...
        function wiki_pre_post_update( $post_ID ){
            ...
            if ( in_array( get_post_type(), $supported_posts ) ) {
                ...
                if( ( rt_biz_get_access_role_cap( RT_WIKI_TEXT_DOMAIN, 'editor' ) || rt_biz_get_access_role_cap( RT_WIKI_TEXT_DOMAIN, 'author' ) ) && (!isset( $_REQUEST['parent_id'] ) || empty( $_REQUEST['parent_id'] ) ) ){
