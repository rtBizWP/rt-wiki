 ...
 *      int $userid
 */
function unSubscription($postid, $userid) {
    global $rtWikiSubscribe;
    if ($rtWikiSubscribe->is_subscribe($postid, $userid)) {
        $subscriber = array(
 ...
 *      int $userid
 */
function unSubscriptionAll($postid) {
    global $rtWikiSubscribe;
    $subscriber = array(
        'attribute_postid' => $postid,
    );
 ...
 *      int $userid
 */
function pageSubscription($postid, $userid, $is_sub_subscribe) {
    global $rtWikiSubscribe;
    if (!$rtWikiSubscribe->is_subscribe($postid, $userid)) {
        $subscriber = array(
            'attribute_postid' => $postid,
